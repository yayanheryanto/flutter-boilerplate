...
const List<AuctionItem> dummyRecommended = [
  ...
  AuctionItem(
    title: 'iPad Pro 12.9" M2 WiFi',
    image: '📱',
    bid: 13900000,
    secs: 86400,
    wishlisted: true,
    tint: Color(0xFF6A1B9A),
    category: AuctionCategory.elektronik,
  ),
];
...
List<AuctionItem> itemsByCategory(AuctionCategory category) => dummyAllItems.where((e) => e.category == category).toList();
